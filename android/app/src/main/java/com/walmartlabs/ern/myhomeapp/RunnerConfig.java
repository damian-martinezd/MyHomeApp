package com.walmartlabs.ern.myhomeapp;

import com.walmartlabs.ern.container.miniapps.MyHomeAppActivity;
...
final class RunnerConfig {
    static final Class MAIN_MINIAPP_ACTIVITY_CLASS = MyHomeAppActivity.class;
